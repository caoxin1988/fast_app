...
class DownloadGZ:
    ...
    def download_gz(cls, date : str):
        # file_url = "http://qv.tv.funshion.com/millet/datapost/rom/
        #               data/start20181108.gz?sign=268188b1325cb6f1210f32f6b581e52a"
        local_file = common.CSV_DIR + cls.__get_app_start_file_name(date)

        if os.path.exists(local_file) and os.path.getsize(local_file) != 0:
            print('file {} exist'.format(local_file))
            return
...
if __name__ == '__main__':
    ...
    if not os.path.exists(common.CSV_DIR):
        print('#### mkdir csv_files')
        os.mkdir(common.CSV_DIR)
